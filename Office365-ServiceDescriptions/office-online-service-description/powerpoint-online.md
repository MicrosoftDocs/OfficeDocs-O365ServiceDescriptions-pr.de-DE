...
PowerPoint Online (früher PowerPoint Web App) erweitert Ihre Microsoft PowerPoint-Erfahrung an den Webbrowser, in dem Sie mit Präsentationen direkt auf der Website arbeiten, in die Präsentation gespeichert ist. Microsoft Office 365-Kunden mit Office Online können anzeigen, erstellen und Bearbeiten von Dateien unterwegs.
...
Wenn Sie die **in PowerPoint geöffnet** Symbolleiste auf die Schaltfläche PowerPoint Online klicken, wird die Präsentation in die PowerPoint-desktop-app geöffnet (sofern Microsoft PowerPoint 2010 oder höher auf dem Computer installiert ist). 
...
## <a name="alignment-bullets-numbers"></a>Ausrichtung, Aufzählungszeichen, Nummerierung
...
## <a name="apply-basic-transitions-and-animations"></a>Anwenden einfacher Übergänge und Animationen
...
## <a name="apply-rich-formatting-to-text-shapes-and-pictures"></a>Anwenden umfangreicher Formatierung auf Text, Formen und Bilder
...
## <a name="apply-themes-and-theme-variants"></a>Anwenden von Designs und Designvarianten
...
## <a name="broadcast-slide-show"></a>Übertragen einer Bildschirmpräsentation
...
## <a name="create-and-manage-slides"></a>Erstellen und Verwalten von Folien
...
## <a name="create-custom-animation"></a>Erstellen einer benutzerdefinierten Animation
...
## <a name="design-tools--advanced"></a>Erweiterte Designtools
...
## <a name="embed-presentation-on-web-or-blog-page"></a>Einbetten einer Präsentation auf einer Web- oder Blogseite
...
Zeigen Sie Präsentationen originalgetreu an: mit Animationen, Übergängen und Audio- und Videoinhalten.
  
## <a name="full-ink-support"></a>Umfassende Freihandunterstützung
...
## <a name="full-selection-of-animations-and-transitions"></a>Umfassende Auswahl an Animationen und Übergängen
...
## <a name="integration-with-excel-for-charts"></a>Integration mit Excel für Diagramme
...
## <a name="present-online-through-skype-for-business-or-the-office-presentation-service"></a>Onlinepräsentation über Skype for Business oder den Office-Präsentationsdienst
...
## <a name="presenter-view"></a>Referentenansicht
...
## <a name="reviewer-tools---advanced"></a>Reviewer-Tools – erweiterte
<a name="bkmk_AdvancedReviewerTools"> </a>

In PowerPoint Online nicht verfügbar. Erweiterte Reviewer-Features, wie Konflikte beim Zusammenführen und vergleichen Präsentationen, sind nur verfügbar in die PowerPoint-desktop-app. Mit dem Online PowerPoint können Sie anzeigen, hinzufügen, bearbeiten oder Löschen von Kommentaren.
...
## <a name="run-slide-show"></a>Durchführen einer Bildschirmpräsentation
...
## <a name="slide-show"></a>Bildschirmpräsentation
...
## <a name="table-creationediting-and-formatting"></a>Erstellen/Bearbeiten und Formatieren einer Tabelle
...
Wenn die Dateien auf SharePoint Online oder OneDrive für Unternehmen gespeichert sind, können Sie hinzufügen, bearbeiten oder Löschen von Kommentaren. 
  
Wenn Ihre Dateien in OneDrive gespeichert sind, können Sie hinzufügen, bearbeiten oder Löschen von Kommentaren in Bearbeitung Ansicht, und Sie anzeigen und aktualisieren Sie Kommentare in der Leseansicht anzeigen können.
  
## <a name="view-and-edit-slide-notes"></a>Anzeigen und Bearbeiten von Foliennotizen
