...
## <a name="design-tools-advanced"></a>Entwurfstools, erweitert
...
PowerPoint für das Web wird von einem Webbrowser aus gestartet und basiert auf einer Internetverbindung. Um offline auf Präsentationen zugreifen zu können, muss auf Ihrem Computer die Microsoft PowerPoint-Desktop-App zum Anzeigen und Bearbeiten von Folien installiert sein.
...
Nicht verfügbar in PowerPoint für das Internet. Mit Microsoft PowerPoint Desktop-App können Sie Ihre Präsentationen mit dem Office Presentation Service, einem kostenlosen öffentlichen Dienst, bereitstellen, der anderen Benutzern das Folgen im Webbrowser ermöglicht. Erfahren Sie mehr über [Office Presentation Service](https://go.microsoft.com/fwlink/?LinkId=272774).
...
Mit PowerPoint für das Web können Sie Ihre Präsentation nur mit einem Webbrowser und einer Internetverbindung ausführen. Erfahren Sie mehr über [grundlegende Aufgaben, die Sie mit PowerPoint für das Internet ausführen können](https://go.microsoft.com/fwlink/?LinkId=272775).
  
## <a name="save-as-or-download-a-copy"></a>Speichern unter oder Herunterladen einer Kopie

PowerPoint für das Internet speichert Ihre Arbeit jedes Mal, wenn Sie eine Änderung vornehmen. Es gibt keinen **Save** -Befehl. Sie können eine Kopie herunterladen, benötigen aber die Microsoft PowerPoint-Desktop-App, um eine lokale Kopie zu bearbeiten.
  
## <a name="shapes"></a>Formen

Word-Grafiken und Diagramme können nicht in PowerPoint für das Internet eingefügt werden, aber PowerPoint für das Internet zeigt Sie wie erwartet an. Bearbeiten und Formatieren von Text in der Bearbeitungsansicht Wenn Sie Texteffekte auf Word Art anwenden möchten, benötigen Sie die Microsoft PowerPoint Desktop-App.
