...
- [Adressbuchbeschränkungen](#abl.md)
    
- [Speicherbegrenzungen für Postfächer](#StorageLimits.md)
    
- [Kapazitätswarnungen](#CapacityAlerts.md)
    
- [Begrenzungen für Postfachordner](exchange-online-limits.md#MailboxFolderLimits)
    
- [Nachrichtengrenzwerte](#MessageLimits.md)
    
- [Empfangs- und Sendegrenzen](#RecipientLimits.md)
    
- [Grenzwerte für Berichterstellung und Nachrichtenablaufverfolgung](exchange-online-limits.md#reporting-and-message-trace-limits)
    
- [Aufbewahrungsgrenzwerte](#RetentionLimits.md)
    
- [Verteilergruppen-Grenzwerte](#DistributionGroupLimits.md)
    
- [Journal-, Transport- und Postfachregelgrenzen](#TransportRuleLimits.md)
    
- [Moderationsgrenzwerte](#ModerationLimits.md)
    
- [Grenzwerte für Exchange ActiveSync](exchange-online-limits.md#exchange-activesync-limits)
...
|Archivipostfächer<sup>7, 8</sup> <br/> |50 GB  <br/> |50 GB  <br/> |50 GB  <br/> |Unlimited<sup>1</sup> <br/> |Unbegrenzte<sup>1</sup> <br/> |Nicht verfügbar<sup>4</sup> <br/> |
...
> [!NOTE]
> <sup>1</sup> Dies ist die Standardeinstellung. Administratoren können diesen Wert für ihre Organisation ändern. > <sup>2</sup> Dies ist der standardmäßige Wert für Exchange Online-Organisationen. Ein Administrator kann diesen Grenzwert für Postfächer in seiner Organisation auf maximal 30 Tage ändern. 
...
> [!NOTE]
> <sup>1</sup> Dies ist der standardmäßige Grenzwert für Exchange Server 2013-Organisationen. Administratoren können diesen Wert für ihre Organisation ändern. > <sup>2</sup> Dieser Grenzwert gilt auch für Administratoren. 
