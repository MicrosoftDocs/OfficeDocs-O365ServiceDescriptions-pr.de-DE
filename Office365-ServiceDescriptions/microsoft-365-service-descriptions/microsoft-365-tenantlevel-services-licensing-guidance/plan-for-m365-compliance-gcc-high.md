...
> [!NOTE]
>Wenn Ihre Organisation bereits die Microsoft 365 Government – GCC Hohe Berechtigungsanforderungen erfüllt und für das Programm beantragt und akzeptiert wurde, können Sie die Schritte 1 und 2 überspringen und direkt zu Schritt 3 wechseln.
 
## <a name="step-1-determine-whether-your-organization-needs-microsoft-365-government--gcc-high-and-meets-eligibility-requirements"></a>Schritt 1. Bestimmen, ob Ihre Organisation eine Microsoft 365 benötigt – GCC hoch und erfüllt die Berechtigungsanforderungen

Die Microsoft 365 Government – GCC High environment entspricht den Anforderungen der US Government für Clouddienste. Organisationen profitieren nicht nur von den Features und Funktionen von Office 365, sondern profitieren auch von den folgenden Features, die für Microsoft 365 Government GCC sind:
...
Weitere Informationen zum Angebot Microsoft 365 Government – GCC High offering for US Government customers finden Sie unter [Office 365 Government-](https://products.office.com/government/compare-office-365-government-plans)und Berechtigungsanforderungen.
...
- *Entscheiden Sie, Microsoft 365 government – GCC-High für Ihre Organisation geeignet ist.*
- *Vergewissern Sie sich, dass Ihre Organisation die Berechtigungsanforderungen erfüllt.*

> [!NOTE]
> Microsoft 365 Government – GCC High ist nur in den USA verfügbar. Kunden außerhalb der USA können aus einer Reihe von Office 365 Government [auswählen.](https://products.office.com/government/compare-office-365-government-plans)

## <a name="step-2-apply-for-microsoft-365-government--gcc-high"></a>Schritt 2. Bewerben Sie sich Microsoft 365 Government – GCC-High
...
## <a name="step-3-understand-microsoft-365-government--gcc-high-default-security-settings"></a>Schritt 3: Verstehen Microsoft 365 Government – GCC-High Standardsicherheitseinstellungen
...
## <a name="step-4-understand-which-capabilities-are-currently-unavailable-or-disabled-by-default-in-microsoft-365-government--gcc-highsup1sup"></a>Schritt 4. Verstehen, welche Funktionen derzeit nicht verfügbar sind oder standardmäßig in Microsoft 365 Government – GCC-High<sup>1 deaktiviert sind</sup>

Um die Anforderungen unserer Government Cloud-Kunden zu erfüllen, gibt es einige Unterschiede zwischen Microsoft 365 Government – GCC-High und Enterprise-Plänen. In der folgenden Tabelle finden Sie Informationen zu den verfügbaren Features. Hier [finden](https://www.microsoft.com/microsoft-365/roadmap?filters=GCC%2CGCC%20High%2CDoD%2CMicrosoft%20Information%20Protection%2CMicrosoft%20Compliance%20center%2COffice%20365%20Data%20Loss%20Prevention%2CSecurity%20and%20Compliance%20center#owRoadmapMainContent) Sie die neuesten Kompatibilitätsproduktupdates, die in der Microsoft 365 veröffentlicht werden.<br><br>

| Bereich | Feature | GCC Hoher Status |
|------|---------|-----------------|
...
| Vertraulichkeitsbezeichnung | Automatische Klassifizierung und Bezeichnung für Office Apps (Word, Excel, PowerPoint, Outlook) über Web, Android, iOS, Windows und Mac | Available |
...
| Vertraulichkeitsbezeichnung | Automatische Klassifizierung und Bezeichnung für Teams, Microsoft 365 Gruppen und SharePoint Websites | Available |
...
| Analyse | Analyse: Maschinelles Lernen mit automatischer Bezeichnung auf Office/Clientseite | Rollout |
...
| Verschlüsselung | Exchange Online der Dienstverschlüsselung mithilfe von verwalteten Microsoft-Schlüsseln | Available |
| Verhinderung von Datenverlust | Verhinderung von Datenverlust (Data Loss Prevention, DLP) für Dateien und E-Mails | Available |
| Verhinderung von Datenverlust | DLP für Teams und Kanalunterhaltungen | Available |
| Verhinderung von Datenverlust | DLP-Endpunkt | In der Entwicklung |
...
| | Information Governance: E-Mail-Archivierung | Available |
| | Information Governance: Standardaufbewahrungsbezeichnungen für SharePoint/OneDrive for Business Bibliotheken, Ordner und Dokumentmappen; Exchange Posteingang; und Office 365 Gruppen | Available |
...
| | Information Governance: Aufbewahrungsrichtlinien für Teams | Rollout |
| | Information Governance: Aufbewahrungsrichtlinien für Teams Besprechungsaufzeichnung | In der Entwicklung |
| | Information Governance: Aufbewahrungsrichtlinien für Teams privaten Kanälen | On Engineering Backlog |
| | Information Governance: Aufbewahrungsrichtlinien für Teams freigegebene Kanäle | On Engineering Backlog |
...
| Datensatzverwaltung | Anwenden von Standarddatensatzbezeichnungen für SharePoint, OneDrive for Business, Ordner und Dokumentmappen; und Office 365 Gruppen | Available |
...
| Datensatzverwaltung | Verwenden SharePoint Syntexklassifizierung zum Anwenden von Datensatzbeschriftungen | On Engineering Backlog |
...
| Kommunikationscompliance | Analysieren Teams Von Chatdaten von Benutzern mit Einem-Prem-Postfach | Available |
...
| Kommunikationscompliance | Erkennen von Inhalten für Erwachsene | On Engineering Backlog |
| Kommunikationscompliance | Erkennt wiederholte Verhaltensverletzungen im Laufe der Zeit | Available |
| Kommunikationscompliance | Eskalieren der Untersuchung für Advanced eDiscovery | Available |
...
| Kommunikationscompliance | Richtlinieninte health check and ability to pause policy | On Engineering Backlog |
| Kommunikationscompliance | Power Automate-Integration | On Engineering Backlog |
| Kommunikationscompliance | Unterstützt sieben Sprachen für die Klassifizierung von Bedrohungen, gezielten Schikanen und Profanitäten | On Engineering Backlog |
| Kommunikationscompliance | Unterstützung für detailliertere Berechtigungen | Available |
| Kommunikationscompliance | Unterstützung für Teams, Exchange und die Möglichkeit zum Entfernen Teams Nachricht | Available |
| Kommunikationscompliance | Microsoft Teams Integration | On Engineering Backlog |
| Kommunikationscompliance | Teams Unterhaltungskontext | On Engineering Backlog |
...
| Informationsbarrieren | Informationsbarrieren | In der Entwicklung |
...
| Insider-Risikomanagement | Geräteindikatoren für Aktivitäten auf Windows 10 Build 1809 und höher | On Engineering Backlog |
| Insider-Risikomanagement | Eskalieren der Untersuchung für Advanced eDiscovery | Available |
...
| Insider-Risikomanagement | Inhalts-Explorer für Insider-Risikomanagement | In der Entwicklung |
...
| Privileged Access Management | Privileged Access Management | On Engineering Backlog |
| **Ermitteln &amp; der Antwort** | Kern-eDiscovery: Überwachung | Available |
...
| eDiscovery | Advanced eDiscovery: Doppelte Byteunterstützung für Chinesisch, Japanisch und Koreanisch | Available |
| eDiscovery | Advanced eDiscovery: E-Mail-Threading | Available |
| eDiscovery | Advanced eDiscovery: Exportieren (Herunterladen, Exportieren, Hinzufügen zu einem anderen Überprüfungssatz) | Available |
| eDiscovery | Advanced eDiscovery: Filtern | Available |
| eDiscovery | Advanced eDiscovery: Speicheroptimierungen | In der Entwicklung |
| eDiscovery | Advanced eDiscovery: Rechtlicher Halteraum für nachrichten Teams privaten Kanälen | Available |
...
| eDiscovery | Advanced eDiscovery: Beinahe doppelte Identifikation | Available |
...
| eDiscovery | Advanced eDiscovery: Verarbeiteter Export mit Ladedatei | Available |
...
| eDiscovery | Advanced eDiscovery: Unterstützung des PST-Exports | Available |
...
| eDiscovery | Advanced eDiscovery: Unterstützen Teams Reaktionen | On Engineering Backlog |
...
| eDiscovery | Advanced eDiscovery: Viewer | Available |
...
| Überwachung | Erweiterte Überwachung: Rechtlicher Halteraum für Teams Nachrichten privater Kanäle | Available |
