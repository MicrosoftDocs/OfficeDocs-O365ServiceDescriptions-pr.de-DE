...
SharePoint in Microsoft 365 unterstützt Organisationen bei der Freigabe und Verwaltung von Inhalten, Kenntnissen und Anwendungen für:
...
Sofern nicht anders angegeben, sind die folgenden Features in allen Plänen verfügbar, die SharePoint und alle eigenständigen SharePoint-Pläne enthalten:

- [Add-In-Hosting: Vom Partner gehostet und von SharePoint gehostet](/sharepoint/dev/sp-add-ins/choose-patterns-for-developing-and-hosting-your-sharepoint-add-in)
...
- [SharePoint Admin Center](/sharepoint/get-started-new-admin-center). Organisationen mit Firstline-Mitarbeitern benötigen mindestens einen Enterprise-Benutzer, um auf das Admin Center zu zugreifen.
- [Der SharePoint-Modernisierungsscanner](/sharepoint/dev/transform/modernize-scanner)
- [SharePoint Online-Verwaltungsshell](/powershell/sharepoint/sharepoint-online/connect-sharepoint-online?view=sharepoint-ps&preserve-view=true). Organisationen mit Firstline-Mitarbeitern benötigen mindestens einen Enterprise-Benutzer, um auf das Admin Center zu zugreifen.
...
- [Einheitliche Überwachung](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance) (Überwachung der Benutzer- und Administratoraktivitäten von SharePoint)
...
- [Erstellen eines Plans (Planner-Integration)](https://support.office.com/article/73040e0a-560e-41a0-b520-47c1a3bab3cb). Erfordert ein Abonnement mit Office 365 und erfordert, dass der Benutzer für Planner lizenziert ist.
...
- Office für die Webintegration. Erfordert ein Abonnement, das Office 365 enthält.
...
- [Mobile SharePoint-App](https://support.office.com/article/539608ac-4725-455e-aea0-9ca1f769849f)
...
- [Websites: Mit Microsoft 365 verbundene Teamwebsites](https://support.office.com/article/75545757-36c3-46a7-beed-0aaa74f0401e). Erfordert ein Abonnement, das Office 365 enthält.
