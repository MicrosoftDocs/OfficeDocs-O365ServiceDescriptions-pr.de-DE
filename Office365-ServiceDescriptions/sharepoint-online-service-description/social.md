...
In Blogs können Unternehmen schnell Informationen zwischen Mitarbeitern, Partnern oder Kunden austauschen. Personen bieten einen Einblick in ein schwieriges Fachgebiet, Inspiration und Beratung oder erklären eine neue Richtlinie oder einen neuen Ablauf.
...
## <a name="company-feed"></a>Unternehmens-Feed

Bei dem Unternehmens-Feed handelt es sich um den öffentlichen Newsfeed einer Organisation. Dem Unternehmen werden alle Beiträge angezeigt, darunter auch jene, die von Personen erstellt wurden, denen Benutzer nicht folgen. Erfahren Sie mehr über den [Unternehmens Feed](https://support.office.com/article/D1A6A747-5789-498F-9DB5-C5692A9C9559).
